...
@Component({
  ...
  template: `<ion-content><main class="page selector">
    ...
    <p class="notice">Selector temporal con datos ficticios. No requiere cuenta y las acciones de demostración no se guardan al recargar.</p>
  </main></ion-content>`,
